---
title: Reservoir history matching with the Volve dataset
output:
  github_document:
      pandoc_args: --webtex
---
...
Summing up the cumulative oil by year we get `r comma(cum_oil_prod_hist_by_year)` sm3.
...
We do the same thing but from other cumlulative, oil by well: `r comma(cum_oil_prod_hist_by_well)` sm3.
