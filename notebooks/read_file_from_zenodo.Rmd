...
```{r}
# Download PRT file from Zenodo

zfile_link <- "https://zenodo.org/record/2586209/files/VOLVE_2016.PRT?download=1"
temp <- tempfile()
download.file(zfile_link,  temp)

volve_2016_txt <- readLines(temp)
```

```{r}
# original share link for a ZIP file. Extract the ID of the file
temp <- tempfile()

# provide ID for zip file
zfile_link <- "https://zenodo.org/record/2586212/files/VOLVE_2016.zip?download=1"

download.file(zfile_link,  temp, mode = "wb")
